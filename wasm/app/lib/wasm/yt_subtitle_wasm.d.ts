...
export class MarkdownGenerator {
     ...
     * 生成完整的 Markdown 笔记
     */
    generate(job_json: string, segments_json: string, chapters_json: string, frames_json: string): string;
    /**
     * 从 JSON 数据生成 Markdown（别名）
     */
    generate_from_json(job_json: string, segments_json: string, chapters_json: string, frames_json: string): string;
...
export class PptxGenerator {
     ...
     * 导出为 JSON 供前端使用
     */
    export_to_json(job_json: string, segments_json: string, chapters_json: string, frames_json: string): string;
    /**
...
export interface InitOutput {
    ...
    readonly chapterizer_generate_chapter_summary: (a: number, b: number, c: number, d: number, e: number) => [number, number];
    readonly chapterizer_split_chapters: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number];
    ...
    readonly frameextractor_detect_scene_changes: (a: number, b: number, c: number, d: number) => [number, number];
    readonly frameextractor_is_duplicate_frame: (a: number, b: number, c: number, d: number) => number;
    ...
    readonly markdowngenerator_generate: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => [number, number];
    readonly markdowngenerator_new: (a: number, b: number, c: number) => number;
    readonly markdowngenerator_generate_from_json: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => [number, number];
    ...
    readonly audioprocessor_calculate_energy: (a: number, b: number, c: number, d: number) => [number, number];
    ...
    readonly pptxgenerator_export_to_json: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => [number, number];
    readonly pptxgenerator_new: (a: number, b: number, c: number, d: number) => number;
    readonly speechrecognizer_merge_short_segments: (a: number, b: number, c: number, d: number) => [number, number];
    readonly speechrecognizer_new: (a: number, b: number) => number;
    readonly speechrecognizer_parse_whisper_result: (a: number, b: number, c: number, d: number, e: number) => [number, number];
    readonly pptxgenerator_generate: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => [number, number];
