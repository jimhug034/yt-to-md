...
export class Chapterizer {
    ...
    generate_chapter_summary(segments_json, start_time, end_time) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.chapterizer_generate_chapter_summary(this.__wbg_ptr, ptr0, len0, start_time, end_time);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
    ...
    split_chapters(segments_json, total_duration, job_id) {
        ...
        try {
            ...
            const ret = wasm.chapterizer_split_chapters(this.__wbg_ptr, ptr0, len0, total_duration, ptr1, len1);
            deferred3_0 = ret[0];
            deferred3_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
export class FrameExtractor {
    ...
    detect_scene_changes(motion_scores, threshold) {
        ...
        let deferred2_1;
        try {
            const ptr0 = passStringToWasm0(motion_scores, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
...
export class MarkdownGenerator {
    ...
    generate(job_json, segments_json, chapters_json, frames_json) {
        ...
        try {
            ...
            const len1 = WASM_VECTOR_LEN;
            const ptr2 = passStringToWasm0(chapters_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len2 = WASM_VECTOR_LEN;
            const ptr3 = passStringToWasm0(frames_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len3 = WASM_VECTOR_LEN;
            const ret = wasm.markdowngenerator_generate(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
            deferred5_0 = ret[0];
            deferred5_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    generate_from_json(job_json, segments_json, chapters_json, frames_json) {
        ...
        try {
            ...
            const ptr3 = passStringToWasm0(frames_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len3 = WASM_VECTOR_LEN;
            const ret = wasm.markdowngenerator_generate_from_json(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
            deferred5_0 = ret[0];
            deferred5_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
export class PptxGenerator {
    ...
    export_to_json(job_json, segments_json, chapters_json, frames_json) {
        ...
        try {
            ...
            const ptr3 = passStringToWasm0(frames_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len3 = WASM_VECTOR_LEN;
            const ret = wasm.pptxgenerator_export_to_json(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
            deferred5_0 = ret[0];
            deferred5_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    generate(job_json, segments_json, chapters_json, frames_json) {
        ...
        try {
            ...
            const ptr3 = passStringToWasm0(frames_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len3 = WASM_VECTOR_LEN;
            const ret = wasm.pptxgenerator_generate(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
            deferred5_0 = ret[0];
            deferred5_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
export class SpeechRecognizer {
    ...
    merge_short_segments(segments_json, min_duration) {
        ...
        try {
            const ptr0 = passStringToWasm0(segments_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.speechrecognizer_merge_short_segments(this.__wbg_ptr, ptr0, len0, min_duration);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    parse_whisper_result(result_json, job_id) {
        ...
        try {
            ...
            const ptr1 = passStringToWasm0(job_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len1 = WASM_VECTOR_LEN;
            const ret = wasm.speechrecognizer_parse_whisper_result(this.__wbg_ptr, ptr0, len0, ptr1, len1);
            deferred3_0 = ret[0];
            deferred3_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
export function get_processing_stats(captions_json, processed_output) {
    ...
    try {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(processed_output, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
...
const ChapterizerFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_chapterizer_free(ptr >>> 0, 1));
const FrameExtractorFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_frameextractor_free(ptr >>> 0, 1));
const MarkdownGeneratorFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_markdowngenerator_free(ptr >>> 0, 1));
const OcrProcessorFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_ocrprocessor_free(ptr >>> 0, 1));
const PptxGeneratorFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_pptxgenerator_free(ptr >>> 0, 1));
const SpeechRecognizerFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_speechrecognizer_free(ptr >>> 0, 1));
const SummarizerFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
