...
export const chapterizer_generate_chapter_summary: (a: number, b: number, c: number, d: number, e: number) => [number, number];
export const chapterizer_split_chapters: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number];
...
export const frameextractor_detect_scene_changes: (a: number, b: number, c: number, d: number) => [number, number];
export const frameextractor_is_duplicate_frame: (a: number, b: number, c: number, d: number) => number;
...
export const markdowngenerator_generate: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => [number, number];
export const markdowngenerator_new: (a: number, b: number, c: number) => number;
export const markdowngenerator_generate_from_json: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => [number, number];
...
export const audioprocessor_calculate_energy: (a: number, b: number, c: number, d: number) => [number, number];
export const audioprocessor_resample_to_16khz: (a: number, b: number, c: number) => [number, number];
...
export const pptxgenerator_export_to_json: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => [number, number];
export const pptxgenerator_new: (a: number, b: number, c: number, d: number) => number;
export const speechrecognizer_merge_short_segments: (a: number, b: number, c: number, d: number) => [number, number];
export const speechrecognizer_new: (a: number, b: number) => number;
export const speechrecognizer_parse_whisper_result: (a: number, b: number, c: number, d: number, e: number) => [number, number];
export const pptxgenerator_generate: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => [number, number];
